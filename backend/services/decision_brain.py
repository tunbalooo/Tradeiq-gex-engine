...
def _model_confirmation(primary: EntryModelScore, signals: dict) -> tuple[bool, list[str]]:
    # v3.0.7: prefer the explicit model-native candle confirmation generated by
    # engine/model_confirmations.py. The legacy OR groups remain as a safe
    # fallback for older persisted snapshots and external integrations.
