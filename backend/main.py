# Previous release: 3.1.2-silent-real-entry-routing
# Previous release: 3.1.3-institutional-market-map
...
app = FastAPI(title=settings.app_name, version="3.1.6-audit-quality-lifecycle", lifespan=lifespan)
